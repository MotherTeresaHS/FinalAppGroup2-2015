...
function AchievementsScene:draw()
    ...
    text("Complete Lollipop Island", WIDTH/2-200, HEIGHT/2+150)
    text("Complete Chocolate Island", WIDTH/2-200, HEIGHT/2+100)
    text("Complete Gummy Island", WIDTH/2-200, HEIGHT/2+50)
    text("Complete Jellybean Island", WIDTH/2-200, HEIGHT/2)
    text("Complete Sugar Mountain Island", WIDTH/2-200, HEIGHT/2-50)
    --ACHIEVEMENTS (right side)
    text("Complete 50 Equations", WIDTH/2+200, HEIGHT/2+200)
    text("Complete 100 Equations", WIDTH/2+200, HEIGHT/2+150)
    text("Get an equation correct", WIDTH/2+200, HEIGHT/2+100)
    ...
    text("Complete all achievemnts", WIDTH/2+200, HEIGHT/2-150)
end
